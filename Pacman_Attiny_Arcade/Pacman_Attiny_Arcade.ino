...
int ghostsActive = 0;     // How many ghosts are out?
int count = 0;            // Counter
...
static const byte ghost[] PROGMEM = {0x7C,0xFE,0x22,0xEB,0xFF,0x62,0xEA,0x7C};

static const byte openBmp[] PROGMEM = {
0x00,0xC0,0xE0,0xF0,0xF8,0xFC,0xFC,0xFE,0xFE,0xFE,0xFF,0xFF,0xFF,0xFF,0xFE,0xFE,
0xFE,0xFC,0xFC,0xF8,0x70,0x60,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
0x00,0x00,0x00,
...
0x7F,0x3F,0x3F,0x3E,0x1E,0x1E,0x06,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
0x00,0x00,0x00};
...

};
...
void loop() { 
  ...
  ssd1306_char_f6x8(0, 2, "P A C M A N");
      ...
      for (byte lxn = 0; lxn < 3; lxn++) {
        if ( (r >= ghostLoc[lxn][0]) && (r < ghostLoc[lxn][0] + 8) ) { // draw the ghost if any of his body is on this column
          if (c == ghostLoc[lxn][1]/8) {
            out |= (pgm_read_byte(&ghost[r-ghostLoc[lxn][0]]) << ghostLoc[lxn][1] % 8);            
          } else if (c == ghostLoc[lxn][1]/8+1) {
            out |= (pgm_read_byte(&ghost[r-ghostLoc[lxn][0]]) >> (8- ghostLoc[lxn][1] % 8) );
          } 
        }     
      }
...
void moveGhosts(void) {
  ...
  if (ghostCounter >= releaseDelay) {
    if (ghostsActive < maxGhosts) {
      ghostLoc[ghostsActive][0] = 82;
      ghostLoc[ghostsActive][1] = 27;    
      ghostsActive++;
    }
    ghostCounter = 0;
  }

  for (byte lxn = 0; lxn < ghostsActive; lxn++) {
    char clash = 0;  
    switch(ghostDir[lxn]) {
        case(DIR_RIGHT):
          ghostLoc[lxn][0]+=1;
          if (checkCollision(ghostLoc[lxn][0], ghostLoc[lxn][1]) == 1) {ghostLoc[lxn][0]-=1; newDirection(lxn);} else {            
            clash = 0;
            for (byte lxn2 = 0; lxn2 < 3; lxn2++) {
              ghostLoc[lxn][1]--;
              if (checkCollision(ghostLoc[lxn][0], ghostLoc[lxn][1]) == 1) clash = 1; 
            }
            if (clash == 0 && random(100) > BRANCH_PROBABILITY) ghostDir[lxn] = DIR_UP;
            ghostLoc[lxn][1]+=3;            
          }
        break;
        ...
        case(DIR_LEFT):
          ...
          if (checkCollision(ghostLoc[lxn][0], ghostLoc[lxn][1]) == 1) {ghostLoc[lxn][0]+=1; newDirection(lxn);} else {
            ...
            if (clash == 0 && random(100) > BRANCH_PROBABILITY) ghostDir[lxn] = DIR_DOWN;
            ghostLoc[lxn][1]-=3;            
          }
        ...
        case(DIR_UP):
          ghostLoc[lxn][1]-=1;
          if (checkCollision(ghostLoc[lxn][0], ghostLoc[lxn][1]) == 1) {ghostLoc[lxn][1]+=1; newDirection(lxn);} else {
            clash = 0;
            for (byte lxn2 = 0; lxn2 < 3; lxn2++) {
              ghostLoc[lxn][0]--;
              if (checkCollision(ghostLoc[lxn][0], ghostLoc[lxn][1]) == 1) clash = 1; 
            }
            if (clash == 0 && random(100) > BRANCH_PROBABILITY) ghostDir[lxn] = DIR_LEFT;
            ghostLoc[lxn][0]+=3;            
          }
        break;
        ...
        case(DIR_DOWN):
          ...
          if (checkCollision(ghostLoc[lxn][0], ghostLoc[lxn][1]) == 1) {ghostLoc[lxn][1]-=1; newDirection(lxn);} else {                     
            ...
            if (clash == 0 && random(100) > BRANCH_PROBABILITY) ghostDir[lxn] = DIR_RIGHT;
            ghostLoc[lxn][0]-=3;
          }        
        break;      
      }
...
byte hitGhosts(void){
  ...
  for (int lxn = 0; lxn < 3 ;lxn++) {
    if ((ghostLoc[lxn][0] > pacX - 8) && (ghostLoc[lxn][0] < pacX + 8) && (ghostLoc[lxn][1] > pacY - 8) && (ghostLoc[lxn][1] < pacY + 8)) returnCode = 1; 
  }
  return returnCode;
}
...
void movePacman(void) {
  count++;
  if (count == 2) {
  if (mouth == 0) {mouth = 1; beep(30,300);} else {mouth = 0; beep(30,500);}
  count = 0;
  }
